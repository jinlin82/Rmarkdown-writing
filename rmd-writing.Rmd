...
knitr::include_graphics(".\\results\\bibtexkey设置.png")
```
...
knitr::include_graphics(".\\results\\文献题录.png")
```

```{r fig5,eval=T, echo=F,fig.cap="文献题录显示设置",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\文献题录显示设置.png")
```
...
knitr::include_graphics(".\\results\\钥匙.png")
```
...
knitr::include_graphics(".\\results\\Build Tools设置.png")
```
...
knitr::include_graphics(".\\results\\bookdown选择.png")
```
