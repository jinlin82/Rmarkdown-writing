...
```{r fig1,eval=T, echo=F,fig.cap="语言设置",dev="png",results='markup', cache=F}
...
```{r fig2,eval=T, echo=F,fig.cap="bibtexkey设置",dev="png",results='markup', cache=F}
...
```{r fig3,eval=T, echo=F,fig.cap="文献题录",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\文献题录.png")
```

```{r fig4,eval=T, echo=F,fig.cap="文献题录显示设置",dev="png",results='markup', cache=F}
...
```{r fig5,eval=T, echo=F,fig.cap="新增bib文件",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\新增bib文件.png")
```

```{r fig6,eval=T, echo=F,fig.cap="填写文献信息",dev="png",results='markup', cache=F}
knitr::include_graphics(".\\results\\填写文献信息.png")
```

```{r fig7,eval=T, echo=F,fig.cap="文献信息生成",dev="png",results='markup', cache=F}
...
```{r fig8,eval=T, echo=F,fig.cap="钥匙",dev="png",results='markup', cache=F}
...
```{r fig10,eval=T, echo=F,fig.cap="知网",dev="png",results='markup', cache=F}
